...
- **[Stockroom Ledger](https://github.com/kyan9400/stockroom-ledger)** — A full-stack inventory operations console with audited cycle counts, atomic location transfers, idempotent writes, optimistic concurrency, and a hardened container deployment.
...
- **[LeaseQueue](https://github.com/kyan9400/leasequeue)** — A durable background-job service with atomic leases, crash recovery, idempotent submission, bounded retries, dead-letter redrive, and Prometheus metrics.
- **[Pulseboard](https://github.com/kyan9400/pulseboard)** — A self-hosted uptime monitor with async checks, automatic incident recovery, SLO error-budget reporting, a public status page, Prometheus metrics, and a non-root container.
- **[Webhook Workbench](https://github.com/kyan9400/webhook-workbench)** — A self-hosted webhook inspector with multi-channel capture, GitHub, Stripe, and generic HMAC verification, guarded replay, SSRF protections, and cross-platform releases.
